...
namespace PHRMS.Data
{
    ...
    public interface IRepository<TEntity, TPrimaryKey> : IReadOnlyRepository<TEntity> where TEntity : class
    {
        ...
        ///     If an entity with the given primary key value exists in the unit of work, then it is returned immediately without
        ///     making a request to the store.
        ///     Otherwise, a request is made to the store for an entity with the given primary key value and this entity, if found,
        ///     is attached to the unit of work and returned.
        ...
        /// <summary>
        ///     Marks the given entity as Deleted such that it will be deleted from the store when IUnitOfWork.SaveChanges is
        ///     called.
        ...
        /// <summary>
        ///     Reloads the entity from the store overwriting any property values with values from the store and returns a reloaded
        ///     entity.
        ...
        /// <summary>
        ///     Determines whether the given entity has the primary key assigned (the primary key is not null). Always returns true
        ///     if the primary key is a non-nullable value type.
        /// </summary>
