namespace PHRMS.Data
{
    ...
    public interface IUnitOfWork
    {
        ...
        /// <summary>
        ///     Changes the state of the specified entity to Modified if changes are not automatically tracked by the
        ///     implementation.
        /// </summary>
        ...
        /// <summary>
        ///     Checks if the unit of work is tracking any new, deleted, or changed entities or relationships that will be sent to
        ///     the store if SaveChanges() is called.
        /// </summary>
        bool HasChanges();
    }
