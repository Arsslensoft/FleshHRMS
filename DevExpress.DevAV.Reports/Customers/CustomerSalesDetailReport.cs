...
namespace DevExpress.DevAV.Reports {
    public class CustomerSalesDetailReport : DevExpress.XtraReports.UI.XtraReport {
        ...
        void UpdateChartFilter() {
            ...
            new DevExpress.XtraCharts.DataFilter("OrderDate", "System.DateTime", DevExpress.XtraCharts.DataFilterCondition.GreaterThanOrEqual, paramFromDate.Value),
            new DevExpress.XtraCharts.DataFilter("OrderDate", "System.DateTime", DevExpress.XtraCharts.DataFilterCondition.LessThanOrEqual, paramToDate.Value)});
        }
