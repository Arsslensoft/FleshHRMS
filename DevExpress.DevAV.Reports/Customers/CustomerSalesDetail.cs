...
namespace DevExpress.DevAV.Reports {
    public class CustomerSalesDetail : DevExpress.XtraReports.UI.XtraReport {
        ...
        public void SetChartData(object data) {
            ...
            xrChart1.Series[0].ArgumentDataMember = "Product.Category";
            UpdateChartFilter();
        }
        void UpdateChartFilter() {
            xrChart1.Series[0].DataFilters.ClearAndAddRange(new DevExpress.XtraCharts.DataFilter[] {
            new DevExpress.XtraCharts.DataFilter("Order.OrderDate", "System.DateTime", DevExpress.XtraCharts.DataFilterCondition.GreaterThanOrEqual, paramFromDate.Value),
            new DevExpress.XtraCharts.DataFilter("Order.OrderDate", "System.DateTime", DevExpress.XtraCharts.DataFilterCondition.LessThanOrEqual, paramToDate.Value)});
        }

        private void InitializeComponent() {
            this.components = new System.ComponentModel.Container();
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CustomerSalesDetail));
            ...
            this.paramFromDate.ValueInfo = "2011-01-01";
            ...
            this.paramToDate.ValueInfo = "2013-01-01";
            ...
            new DevExpress.XtraReports.UI.XRBinding("Text", null, "Store.City")});
            ...
            this.xrTableCell8.Text = "[Customer.HomeOffice.Line]\r\n[Customer.HomeOffice.CityLine]";
            this.xrTableCell8.Weight = 1.4122964395059121D;
            this.xrTableCell9.Multiline = true;
            this.xrTableCell9.Name = "xrTableCell9";
            this.xrTableCell9.Text = "[Customer.BillingAddress.Line]\r\n[Customer.BillingAddress.CityLine]";
            ...
            new DevExpress.XtraReports.UI.XRBinding("Text", null, "Customer.Phone")});
            this.xrTableCell12.Name = "xrTableCell12";
            this.xrTableCell12.Weight = 1.4122964395059121D;
            this.xrTableCell13.DataBindings.AddRange(new DevExpress.XtraReports.UI.XRBinding[] {
            new DevExpress.XtraReports.UI.XRBinding("Text", null, "Customer.Fax")});
            ...
            new DevExpress.XtraReports.UI.XRBinding("Image", null, "Customer.Image")});
            ...
            this.xrTable1,
            this.xrTable5});
            this.ReportHeader.HeightF = 655.056F;
        ...
        series1};
            ...
            this.xrTable1.LocationFloat = new DevExpress.Utils.PointFloat(0F, 564.4311F);
            ...
            this.xrTable5.LocationFloat = new DevExpress.Utils.PointFloat(5.928095F, 626.931F);
            ...
            new DevExpress.XtraReports.UI.XRBinding("Text", null, "OrderItems.Product.Category")});
        ...
        private void xrLabel11_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e) {
            Product currentProduct = (Product)DetailReport.GetCurrentColumnValue("Product");
            if(currentProduct != null) {
                (sender as XRLabel).Text = EnumDisplayTextHelper.GetDisplayText(currentProduct.Category);
            }
        }

        private void xrTableCell50_SummaryRowChanged(object sender, EventArgs e) {
            CustomerStore currentStore = (CustomerStore)GetCurrentColumnValue("Store");
            List<OrderItem> orderItems = (List<OrderItem>)GetCurrentColumnValue("OrderItems");
            decimal total = 0;
        ...
        private void xrTableCell50_SummaryGetResult(object sender, SummaryGetResultEventArgs e) {
            e.Result = storeSales.Count == 0 ? " - " : storeSales.Aggregate((x, y) => x.Value > y.Value ? x : y).Key.City;
            e.Handled = true;
        }
