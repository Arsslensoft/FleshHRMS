...
namespace DevExpress.DevAV.Reports {
    public class SalesOrdersSummaryReport : DevExpress.XtraReports.UI.XtraReport {
        ...
        private void xrLabel4_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e) {
            ProductCategory currentProductCategory = (ProductCategory)GetCurrentColumnValue("ProductCategory");
            (sender as XRLabel).Text = EnumDisplayTextHelper.GetDisplayText(currentProductCategory).ToUpper();
        }
