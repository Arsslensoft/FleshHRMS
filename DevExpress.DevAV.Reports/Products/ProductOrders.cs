...
namespace DevExpress.DevAV.Reports {
    public class ProductOrders : DevExpress.XtraReports.UI.XtraReport {
        ...
        private void InitializeComponent() {
            ...
            series1.ArgumentDataMember = "Order.Store.Address.State";
        ...
        series1};
            ...
            new DevExpress.XtraReports.UI.XRBinding("Text", null, "totalCost", "{0:$#,#}")});
            ...
            new DevExpress.XtraReports.UI.XRBinding("Text", null, "Order.Store.Address.State")});
            ...
            new DevExpress.XtraReports.UI.GroupField("Order.Store.Address.State", DevExpress.XtraReports.UI.XRColumnSortOrder.Ascending)});
    ...
    "meters.paramToDate]].Sum([ProductUnits]) * [Product.Cost]";
        ...
        private void xrLabel4_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e) {
            Order currentOrder = (Order)GetCurrentColumnValue("Order");
            if(currentOrder != null && states != null)
                (sender as XRLabel).Text = states.Last(element => element.ShortName == currentOrder.Store.Address.State).LongName.ToUpper();
        }

        private void CustomerSalesSummary_DataSourceDemanded(object sender, EventArgs e) {
            if(Equals(true, paramOrderDate.Value)) {
                xrTableCell6.Text = "Grouped by State | Sorted by Order Date";
