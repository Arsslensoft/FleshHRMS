...
namespace PHRMS.Widgets
{
    public partial class GlobalStatsWidget : UserControl, IDashboardWidget
    {
        ...
        {
            Controls.Add(GetWorkTimeChartControl(value));
        }
        ...
        public ChartControl GetWorkTimeChartControl(BoardViewModel value)
        {
            ...
            //// Create a pie series.
            var series1 = new Series("Temps de travail", ViewType.FullStackedBar);
            var series2 = new Series("Temps de retards", ViewType.FullStackedBar);
            var series3 = new Series("Temps supplémentaires", ViewType.FullStackedBar);
            var series4 = new Series("Temps d'absence", ViewType.FullStackedBar);
            var series5 = new Series("Temps de congés", ViewType.FullStackedBar);
        ...
        private IEnumerable<WorkTime> CacheStats(BoardViewModel bv)
        {
            ...
            if (File.Exists(Application.StartupPath + "\\Data\\globalstats.dat"))
            {
                if (
                    DateTime.Now.Subtract(
                        new FileInfo(Application.StartupPath + "\\Data\\globalstats.dat").LastWriteTime).TotalDays >= 1)
                {
