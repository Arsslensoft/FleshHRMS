...
namespace PHRMS.ViewModels
{
    ...
    {
        [Display(Name = "Employee of The Month")] EmployeeOfTheMonth,
        [Display(Name = "Probation Notice")] ProbationNotice,
        [Display(Name = "Service Excellence")] ServiceExcellence,
        [Display(Name = "Thank you note")] ThankYouNote,
        [Display(Name = "Welcome to DevAV")] WelcomeToDevAV
    }
