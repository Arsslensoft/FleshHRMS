...
namespace PHRMS.ViewModels {
    ...
    /// </summary>
    public partial class AttendancesViewModel : SingleObjectViewModel<Attendance, long, IPhexonDbUnitOfWork> {
        ...
        protected AttendancesViewModel(IUnitOfWorkFactory<IPhexonDbUnitOfWork> unitOfWorkFactory = null)
            : base(unitOfWorkFactory, x => x.Attendances, x => x.Reason) {
        }
