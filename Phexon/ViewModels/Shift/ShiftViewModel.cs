...
namespace FHRMS.ViewModels {
    ...
    /// </summary>
    public partial class ShiftViewModel : SingleObjectViewModel<Shift, long, IDevAVDbUnitOfWork> {
        ...
        protected ShiftViewModel(IUnitOfWorkFactory<IDevAVDbUnitOfWork> unitOfWorkFactory = null)
