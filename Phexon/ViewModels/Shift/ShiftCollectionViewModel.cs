...
namespace FHRMS.ViewModels {
    ...
    /// </summary>
    public partial class ShiftCollectionViewModel : CollectionViewModel<Shift, long, IDevAVDbUnitOfWork> {
        ...
        protected ShiftCollectionViewModel(IUnitOfWorkFactory<IDevAVDbUnitOfWork> unitOfWorkFactory = null)
            : base(unitOfWorkFactory, x => x.Shifts) {
        }
        public ShiftCollectionViewModel()
