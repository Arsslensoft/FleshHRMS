    ...
    public static class ItemsHideHelper
    {
        ...
        public static void HideCore(ICollection baseItemCollection, SimpleLabelItem button, bool conversely)
        {
            ...
            if (conversely)
            {
                button.Image =
                    Image.FromStream(
                        Assembly.GetEntryAssembly().GetManifestResourceStream("PHRMS.Resources.ArrowLeft.png"));
            }
            else
            {
                button.Image =
                    Image.FromStream(
                        Assembly.GetEntryAssembly().GetManifestResourceStream("PHRMS.Resources.ArrowRight.png"));
            }
        }
