...
namespace DevExpress.XtraGrid.Views.Grid
{
    public class GridViewWithButtons : GridView
    {
        ...
        protected GridColumn buttonsColumnInternal;
        ...
        {
            get { return buttonsEventProvider; }
            set
            {
        ...
        private void DrawButtonsPanel(RowCellCustomDrawEventArgs e)
        {
        ...
        protected override void RefreshVisibleColumnsList()
        {
            ...
            if (GetShowButtons())
            {
                ...
                if (ScrollInfo.IsOverlapScrollBar && buttonsColumnInternal != null &&
                    buttonsColumnInternal == lastColumn)
                {
                    ButtonsPanel.Padding = new Padding(0, 0, ScrollInfo.VScrollSize, 0);
                }
                else
                {
        ...
        protected override Padding GetRowCellPadding(GridColumn column)
        {
            if (column != null && column == buttonsColumnInternal)
            {
                if (buttonsViewInfo.Width > 0)
                {
                    return new Padding(0, 0, buttonsViewInfo.Width + 10, 0);
                }
            }
