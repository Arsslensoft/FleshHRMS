...
namespace DevExpress.XtraEditors.Controls
{
    public class ButtonsPanel : IDisposable
    {
        ...
        protected virtual EditorButtonObjectInfoArgs PrepareButton(ButtonsPanelInfo viewInfo, Graphics g,
            Rectangle bounds, EditorButtonObjectInfoArgs button)
        {
    ...
    public class ButtonsPanelInfo
    {
        ...
        public bool BoundsChanged { get; set; }

        public EditorButtonPainter Painter { get; set; }

        protected EditorButton PressedButton { get; set; }

        protected EditorButton HotButton { get; set; }
        ...
        private bool PressButton(EditorButtonObjectInfoArgs button)
        {
