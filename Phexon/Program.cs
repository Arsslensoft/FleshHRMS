    ...
    internal static class Program {
        ...
        private static void Main() {
            ...
            using(IDisposable singleInstanceApplicationGuard = DataDirectoryHelper.SingleInstanceApplicationGuard("DevExpressWinHybridApp", out exit)) {
                ...
                PHRMS.Utils.DeviceDetector.SuggestHybridDemoParameters(out touchScaleFactor, out fontSize);
        ...
        public static Icon AppIcon {
            get { return DevExpress.Utils.ResourceImageHelper.CreateIconFromResourcesEx("PHRMS.Resources.phexon.ico", typeof(MainForm).Assembly); }
        }
        ...
        public static bool IsTablet {
            get {
                if (isTablet == null) {
                    isTablet = PHRMS.Utils.DeviceDetector.IsTablet;
                }
