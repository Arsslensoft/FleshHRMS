...
namespace PHRMS.Modules {
    public partial class ModifierEmployé : BaseModuleControl {
        ...
        void InitializeData()
        {
            roleLookUpEdit.Properties.Items.AddEnum<PHRMS.Data.EmployeeRole>();
            statusLookUpEdit.Properties.Items.AddEnum<PHRMS.Data.EmployeeStatus>();
            departmentLookUpEdit.Properties.Items.AddEnum<PHRMS.Data.EmployeeDepartment>();
        }
