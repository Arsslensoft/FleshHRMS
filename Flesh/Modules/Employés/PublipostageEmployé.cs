namespace FHRMS.Modules {
    ...
    public partial class PublipostageEmployé : BaseModuleControl {
        public PublipostageEmployé()
        ...
        void InitializeButtonPanel() {
            ...
            listBI.Add(new ButtonInfo() { Type = typeof(SimpleButton), Text = "Imprimer", Name = "3", Image = ImageHelper.GetImageFromToolbarResource("Print"), mouseEventHandler = PrintMouseClick });
            listBI.Add(new ButtonInfo());
