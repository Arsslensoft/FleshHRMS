namespace FHRMS.Modules {
    ...
    public partial class ImprimerEmployé : BaseModuleControl {
        ...
        private void InitializeButtonPanel() {
            ...
            listBI.Add(new ButtonInfo() { Type = typeof(SimpleButton), Text = "Zoomer", Name = "1", Image = ImageHelper.GetImageFromToolbarResource("ZoomIn"), mouseEventHandler = zoomInClick });
            ...
            listBI.Add(new ButtonInfo() { Type = typeof(SimpleButton), Text = "Imprimer", Name = "3", Image = ImageHelper.GetImageFromToolbarResource("Print") });
            listBI.Add(new ButtonInfo());
            listBI.Add(new ButtonInfo() { Type = typeof(SimpleButton), Text = "Options", Name = "4", Image = ImageHelper.GetImageFromToolbarResource("Settings"), mouseEventHandler = settingMouseClick });
            listBI.Add(new ButtonInfo() { Type = typeof(SimpleButton), Text = "Fermer", Name = "5", Image = ImageHelper.GetImageFromToolbarResource("Cancel"), mouseEventHandler =  closeButtonClick });
