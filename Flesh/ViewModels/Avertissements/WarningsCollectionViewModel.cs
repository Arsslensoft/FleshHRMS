...
namespace FHRMS.ViewModels {
    ...
    /// </summary>
    public partial class WarningsCollectionViewModel : CollectionViewModel<Warning, long, IDevAVDbUnitOfWork> {
        ...
        protected WarningsCollectionViewModel(IUnitOfWorkFactory<IDevAVDbUnitOfWork> unitOfWorkFactory = null)
