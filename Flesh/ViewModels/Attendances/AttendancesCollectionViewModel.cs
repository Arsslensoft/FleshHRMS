...
namespace FHRMS.ViewModels {
    ...
    /// </summary>
    public partial class AttendancesCollectionViewModel : CollectionViewModel<Attendance, long, IDevAVDbUnitOfWork> {
        ...
        protected AttendancesCollectionViewModel(IUnitOfWorkFactory<IDevAVDbUnitOfWork> unitOfWorkFactory = null)
