...
namespace FHRMS.ViewModels {
    ...
    /// </summary>
    public partial class AttendancesViewModel : SingleObjectViewModel<Attendance, long, IDevAVDbUnitOfWork> {
        ...
        protected AttendancesViewModel(IUnitOfWorkFactory<IDevAVDbUnitOfWork> unitOfWorkFactory = null)
