...
namespace FHRMS.ViewModels {
    ...
    /// </summary>
    public partial class HolidayViewModel : SingleObjectViewModel<Holiday, long, IDevAVDbUnitOfWork> {
        ...
        protected HolidayViewModel(IUnitOfWorkFactory<IDevAVDbUnitOfWork> unitOfWorkFactory = null)
