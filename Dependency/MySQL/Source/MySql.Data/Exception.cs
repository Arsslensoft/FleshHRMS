...
namespace MySql.Data.MySqlClient
{
  ...
  public sealed class MySqlException : DbException
  {
    ...
    public MySqlException(string msg, bool isFatal, Exception inner)
      : base(msg, inner)
    {
      this.isFatal = isFatal;
    }

    public MySqlException(string msg, int errno, Exception inner)
      : this(msg, inner)
    {
      errorCode = errno;
#if !CF
    ...
    public MySqlException(string msg, int errno)
      : this(msg, errno, null)
    {
    }
