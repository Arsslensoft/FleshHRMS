...
{
  internal class MySqlProviderManifest : System.Data.Entity.Core.Common.DbXmlEnabledProviderManifest
  {
    ...
    protected override XmlReader GetDbInformation(string informationType)
    {
      ...
      if (informationType == System.Data.Entity.Core.Common.DbProviderManifest.StoreSchemaMapping)
      {
        return GetStoreSchemaMapping();
      }

      throw new System.Data.Entity.Core.ProviderIncompatibleException(String.Format("The provider returned null for the informationType '{0}'.", informationType));
    }
